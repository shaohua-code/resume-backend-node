...
const TABLE_WHITELIST = new Set([
  'users', 'otp_codes', 'refresh_tokens', 'user_profile', 'resume', 'resume_history', 'export_record',
  'membership_plan', 'order_record', 'ai_call_record', 'system_config', 'announcement',
  'ai_model', 'ai_task_model', 'user_ai_task_model', 'ai_task_prompt', 'user_ai_task_prompt',
  'admin_action_log', 'user_feedback', 'user_wallet', 'balance_ledger',
  'admin_user_relation', 'invite_link', 'visit_log', 'admin_recharge_config',
  'recharge_request',
])
